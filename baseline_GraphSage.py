...
model = BotSpot(edge_dataset_train, edge_dataset_test, split_num, X, X_more_feats, gbm_best_model=None,
                agg='mean',use_graphsage = True,split_bots_normal =False)
model.to(Device)
...
train(model, data_loader, data_loader_test, optimizer, 4, thres=0.5, weight=None, agg='mean', save_name = date_name,multilayer= False,graphsage = True)
