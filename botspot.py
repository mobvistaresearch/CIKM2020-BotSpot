...
agg = 'mean'
model = BotSpot(edge_dataset_train, edge_dataset_test, split_num, X, X_more_feats, gbm_best_model=gbm_best_model,
                agg=agg)
...
#
train(model, data_loader, data_loader_test, optimizer,5, thres=0.5, weight=None, agg=agg, save_name = date_name,multilayer= False)
